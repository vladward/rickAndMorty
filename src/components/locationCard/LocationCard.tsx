...
export const LocationCard: FC<LocationCardType> = ({ type, dimension, name }) => {
  const styles = useStyles();
  return (
    <Card
      className={styles.characterCardInfoLocation}
      variant={'elevation'}
      elevation={24}
    >
      <BlockTitle title='location' color='black' fontWeight={600} />
...
type LocationCardType = Pick<Location, 'name' | 'type' | 'dimension'>;
